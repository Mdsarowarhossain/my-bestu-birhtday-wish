$( document ).ready(function() {
  biethdaytimer();
setTimeout(() => {
  $(".nightmode").fadeIn(1000);
  setTimeout(() => {
    $(".nightmode").fadeOut(1000);
    startCounting();
...
function biethdaytimer() {
let timermainf = document.getElementById("bt123");
let numero = document.createElement("div");
numero.classList.add("numero_counting_wrapper");
let numeros = document.createElement("div");
numeros.classList.add("numero_shape");
numero.appendChild(numeros);
}

var interval , sum=10;
var audio = new Audio("timertone.mp3");

function startCounting() {


 interval = setTimeout(startaudio, 1000);

}

function startaudio() {
  $('#initial').fadeOut('slow').delay(50).promise().done(function(){
    // $('#turn_on').fadeIn('slow');
  });
setTimeout(() => {
  ...
  $('#turn_on').fadeOut('slow').delay(5000).promise().done(function(){
    ...
    $('#play').click(function(){
      ...
      $(this).fadeOut('slow').delay(5000).promise().done(function(){
        $('#play').fadeOut('slow').delay(5000).promise().done(function(){
